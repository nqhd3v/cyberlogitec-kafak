...
import { TerminalCarrierType } from '../../carrier-type/entities/carrier-type';
import { TerminalConfiguration } from '../../configuration/entities/configuration';
import { TerminalOperationType } from '../../operation-type/entities/operation-type';
